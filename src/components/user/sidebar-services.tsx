...
const SidebarServices = ({ handleNewChat }: { handleNewChat: () => void }) => {
  return (
    <div
      className="w-72 bg-white/90 backdrop-blur-sm border-r border-gray-200/50 flex flex-col flex-shrink-0 animate-fade-in-down"
